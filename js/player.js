...
var key = $("#music")
	.attr("key"); //key密钥
consolelog('陌禅_Music v' + XPLAYER_VERSION + ' BY:mochan', api);
$("head")
...
if (css(span, "font-family") === "FontAwesome") {
	...
	$("head")
		.append("<link rel='stylesheet' id='font-awesome-css'  href='//cdn.bootcdn.net/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css' type='text/css' media='all' />")
};
